...
export default function LoginScreen() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // Lưu user info vào AsyncStorage (tuỳ nhu cầu)
      ...
      if (axios.isAxiosError(error) && error.response) {
        ...
        Toast.show("Network error or server is down!", {
          type: "danger",
        });
      }
    }
    ...
    >
      <ScrollView>
        ...
        <Text style={styles.learningText}>
          Login to your existing account of Elearning
        </Text>
